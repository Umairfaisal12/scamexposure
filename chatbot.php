                ...
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="post-preview">
                        ...
                        <p class="post-meta">
                            ...
                            Posted by <b><?php echo htmlentities($result->username); ?></b> on <?php echo htmlentities($result->creationdate); ?>
                        </p>
                        <p style="font-weight: bold;"><?php echo htmlentities($result->grabber); ?></p>
                        <?php if (!empty($result->image1)) { ?>
                        <p>
                            <img class="img-fluid" src="assets/img/postimages/<?php echo htmlentities($result->image1); ?>" 
                                 style="border:solid 1px #000" alt="Post Image">
                        </p>
                        <?php } ?>
                            ...
                            <form name="Comment" method="post">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" 
                                           ...
                                           class="form-control" placeholder="Enter your Valid email" autocomplete="off" required>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary float-right" name="submit">
                                    <?php echo $_SESSION['login'] ? 'Submit' : '<a href="login.php">Log in & Comment</a>'; ?>
                                </button>
                            </form>
                        </div>
                    </div>
